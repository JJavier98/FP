...
tendrá que usar la clase SecuenciaEnteros, análoga a SecuenciaCaracteres,
cuya definición puede encontrarse en:

http://decsai.ugr.es/~carlos/FP/SecuenciaEnteros.cpp

Cambie la implementación del método Moda del ejercicio 5 para que use este nuevo
método.
