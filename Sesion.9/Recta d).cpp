...
/*
Como en el apartado anterior ya hice el método para asignar los tres coeficientes a la vez,
en este implementaré los métodos de asignaciones individuales.
*/
...
public:
	void SetARecta2(double valorA2){
		A = valorA2;
	}
	void SetBRecta2(double valorB2){
		B = valorB2;
	}
	void SetCRecta2(double valorC2){
		C = valorC2;
	}
	void SetARecta1(double valorA1){
		A = valorA1;
	}
	void SetBRecta1(double valorB1){
		B = valorB1;
	}
	void SetCRecta1(double valorC1){
		C = valorC1;
	}
...
int main(){
	...
	recta_2.SetCoeficientesRecta2(valorA2 , valorB2 , valorC2);
		/*
		recta_1.SetARecta1(valorA1);
		recta_1.SetBRecta1(valorB1);
		recta_1.SetCRecta1(valorC1);
	
		recta_2.SetARecta2(valorA2);
		recta_2.SetBRecta2(valorB2);
		recta_2.SetCRecta2(valorC2);
		*/
